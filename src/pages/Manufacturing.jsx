...
const CNCParts1 = null; // MISSING from Cloudinary
const CNCParts2 = 'https://res.cloudinary.com/dpe1tjjay/image/upload/v1770348553/CNCParts2_fdwvoo.jpg';
const CNCParts3 = 'https://res.cloudinary.com/dpe1tjjay/image/upload/v1770348554/CNCParts3_qyt8cu.jpg';
const cncmillingmachine = 'https://res.cloudinary.com/dpe1tjjay/image/upload/v1770347165/cncmillingmachine_ukxjnq.jpg';
const _3DPrinterBefore1 = 'https://res.cloudinary.com/dpe1tjjay/image/upload/v1770346715/3DPrinterBefore1_q5uxv0.jpg';
const _3DPrinterBefore2 = 'https://res.cloudinary.com/dpe1tjjay/image/upload/v1770346726/3DPrinterBefore2_f64t0v.jpg';
const _3dprintedgridfinity = 'https://res.cloudinary.com/dpe1tjjay/image/upload/v1770346713/3dprintedgridfinity_e52fbn.jpg';
const _3DPrintedPerson = 'https://res.cloudinary.com/dpe1tjjay/image/upload/v1770346713/3DPrintedPerson_forsurgicalinstrumenttesting_zefuuw.jpg';
const Modix1 = null; // MISSING from Cloudinary
...
const Casting = 'https://res.cloudinary.com/dpe1tjjay/image/upload/v1770346721/Casting_pgqvja.jpg';
...
const manufacturingData = [
  {
    ...
    media: [CNCParts3].filter(Boolean),
  ...
  },
  {
    ...
    media: [CNCParts1, CNCParts2, cncmillingmachine, CNCMilling1, CNCMilling2, CNCMilling3, WatchMilling1, WatchMilling2].filter(Boolean),
    projects: ["Precision Wristwatch"]
  },
  {
    ...
    media: [_3DPrinterBefore1, _3DPrinterBefore2, _3dprintedgridfinity, _3DPrintedPerson, Voron1, Voron2, Modix1].filter(Boolean),
  ...
  },
  {
    ...
    media: [buildingfilamentwinder, WeldedFoot1].filter(Boolean),
